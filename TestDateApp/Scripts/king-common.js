$(document).ready(function(){
	...
	function calculateContentMinHeight() {
		$('#main-content-wrapper').css('min-height', $('#left-sidebar').height() - $("div.top-bar").height() - 10);
	}
	...
	//	basePath: ".", // please see documentation for this setting
	//	steps: [
	//		{	
